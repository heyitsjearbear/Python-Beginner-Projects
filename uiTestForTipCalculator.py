...
imge=Image.open("E:\Downloads\jew.png")
...
def tip_calculation_win():
    ...
    label_02 = Label(window, text = 'your tip is this number', relief = "solid", font = ('arial', 12, 'bold')).place(x = 30, y = 70)
    but_01 = Button(root, text='demo',width=12,bg='brown',fg='white').place(x = 80, y=110)
